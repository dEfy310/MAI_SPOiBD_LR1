...
from mysite.anketa.models import Naviki, Sertifikat, Grazhdanin, Voprosi
...
class Otvet(models.Model):
    ...
    otvet = models.ForeignKey(Voprosi, on_delete=models.PROTECT, default=None, verbose_name="Вопросы")
